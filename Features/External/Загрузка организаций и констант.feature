...
@ТипШага: Загрузка данных.Константы
@Описание: Экспортный сценарий, который перезаполняет или загружает константы
...
@ТипШага: Загрузка данных.Справочники
@Описание: Экспортный сценарий, который перезаполняет или загружает справочник Организации
